...
import { ITaskInstance, ITaskInstanceDocument } from '../models/taskInstance';

// Task request
export const generateTaskInstances = (params: {
	task: ITask;
	task_instances: Array<ITaskInstanceDocument>;
}): [] | ITaskInstance[] => {
...
export const generateSpecificDayInstances = () => {
	// initial params
	const generatedInstances = [];
...
export const generateExtendedInstances = (
	startDate: string,
	endDate: string,
	task: ITask
) => {};
